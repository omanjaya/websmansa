...
final class StaffService extends BaseModelService
{
    ...
    public function getStaffByType(
        ...
        return $this->repository->getByType($type, $paginate ? null : $limit);
    }

    /**
     * Get staff by department - delegates to repository
     */
    public function getStaffByDepartment(string $department): Collection
    {
    ...
    public function getTeachers(
        ...
        if ($department) {
            return $this->getFilteredStaff(['type' => 'teacher', 'department' => $department], $limit, $paginate);
        }

        return $this->repository->getTeachers($paginate ? null : $limit);
    }
