...
final class UpdateFacilityRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'slug' => 'nullable|string|max:255|unique:facilities,slug,'.$facilityId,
            'description' => 'sometimes|required|string',
            'category' => 'sometimes|required|string|in:classroom,laboratory,library,sports,canteen,health,auditorium,multipurpose,parking,worship,toilet,garden,computer,science,language,art,music',
