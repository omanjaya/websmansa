...
final class StoreExtraRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'slug' => 'nullable|string|max:255|unique:extras,slug',
            'description' => 'required|string',
            'short_description' => 'nullable|string|max:500',
            'category' => 'required|string|in:sports,arts,academic,social,technology,language,leadership,volunteer,religious',
