...
export default function PrestasiPage() {
    ...
    const { data, isLoading } = useQuery({
        queryKey: ['admin-posts', 'achievement', page, search],
        queryFn: () => getAdminPosts({ type: 'achievement', page, per_page: 10, search }),
    })
    ...
    return (
        <div className="p-6">
            ...
            <div className="flex items-center justify-between mb-8">
                <div>
                    <h1 className="text-3xl font-bold text-gray-900 dark:text-white">🏆 Prestasi</h1>
                    <p className="mt-2 text-gray-600 dark:text-gray-400">
                        Kelola prestasi dan artikel sekolah
                    </p>
                </div>
                <Link
                                    ...
                                    <tr key={post.id} className="hover:bg-gray-50 dark:hover:bg-slate-700/50">
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex items-center justify-end gap-2">
                                                <Link
                                                    href={`/prestasi/${post.attributes.slug}`}
                                                    target="_blank"
                                                ...
                                                <Link
                                                    href={`/admin/prestasi/${post.id}/edit`}
                                                    className="p-2 text-gray-600 hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-400"
                                                    title="Edit"
                                                >
