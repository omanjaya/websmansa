    ...
    return (
        <div className="p-6">
            ...
            <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                    <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Tambah Prestasi Baru</h1>
                    <p className="mt-2 text-gray-600 dark:text-gray-400">
                        Buat artikel prestasi dengan editor lengkap
                    </p>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                <div className="bg-white dark:bg-slate-800 rounded-2xl border border-gray-200 dark:border-slate-700 p-6">
                    <h2 className="text-lg font-semibold mb-6 dark:text-white">Informasi Prestasi</h2>
                    ...
                    <div className="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                placeholder="Ringkasan singkat prestasi (opsional, akan auto-generate dari konten)"
                            />
                        </div>
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                Konten Prestasi <span className="text-red-500">*</span>
                            </label>
                            <RichTextEditor
                                content={content}
                                onChange={setContent}
                                placeholder="Tulis konten prestasi di sini... Gunakan toolbar untuk formatting, menambah gambar, link, dan video."
                            />
                        </div>
                ...
                <div className="flex items-center justify-end gap-4">
                    ...
                    >
                        {loading ? 'Menyimpan...' : 'Publish Prestasi'}
                    </button>
                </div>
            </form>
        </div>
