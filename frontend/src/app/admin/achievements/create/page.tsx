...
export default function CreateAchievementPage() {
    ...
    const createMutation = useMutation({
        ...
        onError: (error: Error) => {
            toast.error(error.message || 'Gagal menambahkan prestasi')
        },
    })
        ...
        <div className="p-6 max-w-4xl mx-auto">
            ...
            <div className="mb-8">
                ...
                <p className="mt-2 text-gray-600 dark:text-gray-400">
                    Tambahkan data prestasi untuk ditampilkan di carousel homepage
                </p>
            </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        ...
                        <div className="md:col-span-2">
                            ...
                            <input
                                ...
                                placeholder="Juara 1 Olimpiade Sains Nasional"
                            />
                        </div>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                name="organizer"
                                className="w-full px-4 py-3 border border-gray-300 dark:border-slate-600 rounded-xl bg-white dark:bg-slate-800 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                placeholder="Kemendikbud, Universitas, dll"
                            />
                        </div>
