...
import { createAlumni } from '@/lib/api'
...
export default function CreateAlumniPage() {
    ...
    const createMutation = useMutation({
        ...
        onError: (error: Error) => {
            toast.error(error.message || 'Gagal menambahkan alumni')
        },
    })
        ...
        <div className="p-6 max-w-4xl mx-auto">
            ...
            <div className="mb-8">
                ...
                <p className="mt-2 text-gray-600 dark:text-gray-400">
                    Tambahkan data alumni baru untuk ditampilkan di carousel homepage
                </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="flex justify-end gap-4">
                    ...
                    >
                        {createMutation.isPending ? 'Menyimpan...' : 'Simpan Alumni'}
                    </button>
                </div>
            </form>
        </div>
