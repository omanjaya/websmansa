...
export default function PengumumanPage() {
    ...
    const { data, isLoading } = useQuery({
        queryKey: ['admin-posts', 'announcement', page, search],
        queryFn: () => getAdminPosts({ type: 'announcement', page, per_page: 10, search }),
    })
                                    ...
                                    <tr key={post.id} className="hover:bg-gray-50 dark:hover:bg-slate-700/50">
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex items-center justify-end gap-2">
                                                <Link
                                                    href={`/pengumuman/${post.attributes.slug}`}
                                                    target="_blank"
                                                ...
                                                <Link
                                                    href={`/admin/pengumuman/${post.id}/edit`}
                                                    className="p-2 text-gray-600 hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-400"
                                                    title="Edit"
                                                >
